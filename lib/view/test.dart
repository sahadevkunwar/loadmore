...
//   Future<Either<String, List<Datum>>> fetchProductDetail(
...
//       );
//       if (res.data['data']['vehicles']['data'] == null) {
//         // return const Left("No more data available");
//         return Right(_items);
//       }

//       final temp = List.from(res.data['data']['vehicles']['data'])
//           .map((e) => Datum.fromMap(e))
//           .toList();
//       // temp.shuffle();
